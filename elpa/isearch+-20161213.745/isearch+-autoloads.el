...

;;;### (autoloads nil "isearch+" "isearch+.el" (22609 23021 906524
;;;;;;  608000))
...
(defvar isearchp-highlight-regexp-group-levels-flag t "\
*Non-nil means highlight 1-8 regexp group levels, within search hit.
You can toggle this value using \\<isearch-mode-map>`\\[isearchp-toggle-highlighting-regexp-groups]' during Isearch.")

(custom-autoload 'isearchp-highlight-regexp-group-levels-flag "isearch+" t)
...
(autoload 'isearchp-toggle-highlighting-regexp-groups "isearch+" "\
